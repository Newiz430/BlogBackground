<?php
/* Smarty version 3.1.34-dev-7, created on 2020-08-21 18:03:39
  from 'D:\blog\app\admin\view\article\articleEdit.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f3f9bfb9b67f6_00215518',
...
function content_5f3f9bfb9b67f6_00215518 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                            ...
                            <div class="st-form-line" style="z-index: 620;">
                                ...
                                <label class="margin-right10">
                                    <div class="radio">
                                        <span><input type="radio" name="a_topped" class="uniform" value="1" <?php if ($_smarty_tpl->tpl_vars['article']->value['a_topped'] == 1) {?> checked="checked" <?php }?>></span>
                                    </div> 置顶
                                </label>
                                <label class="margin-right10">
                                    <div class="radio">
                                        <span><input type="radio" name="a_topped" class="uniform" value="2" <?php if ($_smarty_tpl->tpl_vars['article']->value['a_topped'] == 2) {?> checked="checked" <?php }?>></span>
                                    </div> 不置顶
                                </label>
                            ...
                            <div class="st-form-line">
                                ...
                                <img src="<?php if ($_smarty_tpl->tpl_vars['article']->value['a_img_thumb']) {
echo URL;?>
/uploads/<?php echo $_smarty_tpl->tpl_vars['article']->value['a_img_thumb'];
} else {
echo P;?>
/img/post01.jpg<?php }?>">
                                <div class="clear"></div>
