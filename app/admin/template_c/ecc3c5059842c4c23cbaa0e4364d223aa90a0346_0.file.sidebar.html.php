<?php
/* Smarty version 3.1.34-dev-7, created on 2020-08-22 18:20:29
  from 'D:\blog\app\admin\view\Public\sidebar.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f40f16d1950d9_09008900',
...
function content_5f40f16d1950d9_09008900 (Smarty_Internal_Template $_smarty_tpl) {
?><div id="sidebar">
...
/img/arrow-down.png" width="7" height="4" alt="arrow" class="arrow" /></a>
                        <ul class="submenu display-block">
                            <li <?php if (strtolower(C) == "category" && strtolower(A) == "index") {?>class="active"<?php }?>><a href="index.php?p=admin&c=category"><img src="<?php echo P;?>
...
/img/icons/sidemenu/file_add.png" width="16" height="16" alt="icon"/>添加博文</a></li>
                        <li <?php if (strtolower(C) == "article" && strtolower(A) == "index") {?>class="active"<?php }?>><a href="index.php?p=admin&c=article"><img src="<?php echo P;?>
...
/img/icons/sidemenu/user_add.png" width="16" height="16" alt="icon"/>添加用户</a></li>
                            <li <?php if (strtolower(C) == "user" && strtolower(A) == "index") {?>class="active"<?php }?>><a href="index.php?p=admin&c=user"><img src="<?php echo P;?>
