<?php
/* Smarty version 3.1.34-dev-7, created on 2020-08-22 17:01:47
  from 'D:\blog\app\home\view\Index\blogShowList.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5f40defba4a465_91745178',
...
function content_5f40defba4a465_91745178 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content text-center">
          ...
          <form method="post" action="index.php?c=user&a=check">
            <input name="u_username" type="username" class="form-control" placeholder="用户名" required>
            <input name="u_password" type="password" class="form-control" placeholder="密码" required>
      ...
      <div class="modal-dialog">
        ...
        <div class="modal-content text-center">
          ...
          <form method="post" action="index.php?c=user&a=register">
            <input name="u_username" type="text" class="form-control" placeholder="用户名" required>
            <input name="u_email" id="email" type="email" class="form-control" placeholder="邮箱" required>
            <input name="u_password" type="password" class="form-control" placeholder="密码" required>
            <div class="form-group">
              <!-- 验证码图片 -->
              <img src="index.php?c=user&a=captcha" width="300px" heigth="60px" style="margin: 0 auto" onclick="this.src='index.php?c=user&a=captcha&'+Math.random()">
            </div>
...
echo P;?>
/img/blog/post01.jpg<?php }?>"> <!-- 用smarty修改信息 -->
            </a><!-- .post-thumb -->
            <div class="post-body">
              <div class="post-meta">
                <div class="column">
          ...
          <aside class="sidebar">
            <section class="widget widget_search">
              <form method="post" class="search-box">
                <input name="a_title" type="text" class="form-control" placeholder=<?php echo (($tmp = @$_smarty_tpl->tpl_vars['cond']->value["a_title"])===null||$tmp==='' ? "按标题搜索博文" : $tmp);?>
>
...
<span><?php echo (($tmp = @$_smarty_tpl->tpl_vars['cat_counts']->value[$_smarty_tpl->tpl_vars['cat']->value['id']]["c"])===null||$tmp==='' ? 0 : $tmp);?>
</span></a></li>
                <!-- 当某分类下没有博文时，显示数目默认为0 -->
                <?php
}
